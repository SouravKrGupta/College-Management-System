...
const Notice = () => {
  ...
  return (
    <div className="w-full mx-auto flex justify-center items-start flex-col my-10" style={{ backgroundImage: 'url(/assets/logo.png)', backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', minHeight: '100vh' }}>
